    ...
    <Link to = '/' >
      ...
      >
        <defs>
          ...
          >
            <stop offset={0} stopColor="#bd18bd" />
            <stop offset={1} stopColor="#f5ff00" />
          </linearGradient>
          <filter
            ...
            height="300%"
          >
            <feFlood floodColor="#e9e5ba" result="flood" />
            <feComposite
              operator="in"
              in2="SourceAlpha"
              in="flood"
              result="shadow"
            />
            <feOffset dx={0.7} dy={-5.6} in="SourceGraphic" result="offset-1" />
            <feOffset dx={-0.7} dy={5.6} in="shadow" result="offset-2" />
            <feMerge>
